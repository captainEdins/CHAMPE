...
import 'package:champe/pages/bottomPages/home/messages/connection/connectFirebase.dart';
import 'package:champe/pages/bottomPages/home/messages/therapist/doctorList.dart';
            ...
            Positioned(
                ...
                child: Row(
                  children: [
                    ...
                    widget.senderId == "us63246543265432" ? InkWell(
                      onTap: (){
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                      ...
                      child: Stack(
                        children: [
                          ...
                          Consumer<VisibilityModel>(
                              builder: (context, visibilityModel, _) {
                                return Visibility(
                                  visible: visibilityModel.isVisible,
                                  child: Positioned(
                                      bottom: 0, left: 5, child: typingProgress()),
                                );
                              })
                        ],
                      ),
                          ...
                          child: SizedBox(
                              ...
                              child: EmojiPicker(
                                ...
                                config: Config(
                                  ...
                                  indicatorColor: ColorList.black,
                                  iconColor: Colors.grey,
                                  iconColorSelected: ColorList.black,
                                  backspaceColor: ColorList.black,
                                  ...
                                  noRecents: const Text(
                                    'No Resents',
                                    style: TextStyle(
                                        fontSize: 20, color: ColorList.purple),
        ...
        child: Container(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              ...
              hintStyle:
              const TextStyle(color: ColorList.white, fontSize: 16),
                ...
                InkWell(
                  ...
                  child: Container(
                      ...
                      child: snap['senderId'] == widget.senderId
                        ...
                        snap['message'],
                        style: TextStyle(
                            fontSize: 15, color: (snap['senderId'] == widget.senderId
                            ? ColorList.black
                            : ColorList.white)),
                      )
                          : ReadMoreText(
